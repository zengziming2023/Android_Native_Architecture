...
/**
 * deal with around event.
 */
abstract class TemplateNodeASMFactory : AsmClassVisitorFactory<InstrumentationParameters.None> {

    override fun createClassVisitor(
        classContext: ClassContext, nextClassVisitor: ClassVisitor
    ): ClassVisitor {
        return TemplateClassNodeVisitor(nextClassVisitor) // TemplateClassVisitor(nextClassVisitor)
    }
