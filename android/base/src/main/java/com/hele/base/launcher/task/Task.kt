package com.hele.base.launcher.task

import android.os.Process
import androidx.annotation.IntRange
import com.hele.base.launcher.executor.TaskExecutor
...
abstract class Task {
     ...
     * 父任务的列表
     */
    open fun getDependsTaskList(): List<Class<out Task>>? = null
     ...
     * 执行线程
     */
    open fun runOnExecutor(): Executor = TaskExecutor.sIOThreadPoolExecutor
